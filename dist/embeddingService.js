...
export class EmbeddingService {
     ...
     */
    constructor(embeddingModel, batchSize = 96, apiDelayMs = 1000, retryOptions = { maxRetries: 3, initialDelay: 1000 }) {
    ...
    async embedTexts(texts) {
        ...
        for (let i = 0; i < texts.length; i += this.batchSize) {
            ...
            if (batchTexts.length === 0)
                continue; // Should not happen with correct loop logic, but safe check
